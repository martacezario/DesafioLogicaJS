...
let dataDenascimento = 1969
console.log(anoAtual - dataDenascimento)

// Mostre no console a data de nascimento da Mariah Carey
console.log(`Mariah Carey nasceu em ${dataDenascimento}`)
...
if(idade >= 18){
    console.log("Você é maior de idade, poderá curtir o show do Roberto Carlos feat Mariah Carey")


} else (idade < 18)
    console.log("Sinto muito, mas terá que assistir pela tv globo!")
